...
from .backbone_utils import resnet_fpn_backbone, shufflenet_fpn_backbone
__all__ = ["FasterRCNN", "fasterrcnn_resnet50_fpn", "fasterrcnn_shufflenet"]
    ...
    def __init__(
        ...
        if box_roi_pool is None:
            box_roi_pool = MultiScaleRoIAlign(
                featmap_names=['0', '1', '2', '3'], # for shufflenet use 0,1,2
                output_size=7,
                sampling_ratio=2)
...
def fasterrcnn_shufflenet(pretrained=False,
                          progress=True,
                          num_classes=91,
    ...
    backbone = shufflenet_fpn_backbone('shufflenet_v2_x1_0', False)
